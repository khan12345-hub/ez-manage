...
export class BoardsController {
  ...
  async search(
    ...
    return this.boardsService.searchBoardTasks(boardId, query, user.id);
  }
  @Get(':id') @RequireBoardPermission(BoardPermission.VIEW) findOne(
    @Param('id', ParseIntPipe) id: number,
    @Query('search') search?: string,
  ) {
    return this.boardsService.findOne(id, search);
  }
  @Get(':boardId/members')
  @RequireBoardPermission(BoardPermission.VIEW)
  findMembers(
  ...
  @Patch(':id') @RequireBoardPermission(BoardPermission.EDIT) update(
    @Param('id', ParseIntPipe) id: number,
  ...
  @Delete(':id') @RequireBoardPermission(BoardPermission.DELETE) remove(
    @Param('id', ParseIntPipe) id: number,
    @CurrentUser() user: SessionUser,
  ) {
